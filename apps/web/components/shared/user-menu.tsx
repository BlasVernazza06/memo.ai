                            ...
                            >
                                <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
                                    <h3 className="font-black text-slate-900 flex items-center gap-2">
                                        Notificaciones
                                        <span className="bg-primary/10 text-primary text-[10px] px-2 py-0.5 rounded-full">3</span>
                                    </h3>
                                ...
                                <div className="p-3 bg-slate-50/50">
                                    <Button variant="ghost" className="w-full rounded-2xl text-xs font-black text-slate-400 hover:text-primary transition-all gap-2">
