        ...
        <section className="py-20 bg-muted/30 relative border-y border-border/50 overflow-hidden">
            ...
            <div className="memo-container px-4">
                ...
                >
                    ...
                    <span className="text-xs font-bold uppercase tracking-[0.2em]">Más de 50.000 horas estudiadas en</span>
                    <div className="h-px w-12 bg-border" />
                </motion.div>
                    ...
                    >
                        {[...universities, ...universities].map((uni, index) => (
                            ...
                            >
                                ...
                                <span className="text-xl font-extrabold tracking-tight text-foreground">{uni}</span>
                            </div>
                        ))}
                    </motion.div>
                </div>
