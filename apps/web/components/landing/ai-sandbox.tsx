...
const SAMPLE_FLASHCARDS: Flashcard[] = [
    {
        ...
        answer: "Es el orgánulo celular encargado de suministrar la mayor parte de la energía necesaria para la actividad celular (ATP)."
    },
    {
        question: "¿Cuál es la función del ADN?",
        answer: "Contiene las instrucciones genéticas usadas en el desarrollo y funcionamiento de todos los organismos vivos."
    },
    {
        question: "¿Qué es la Homeostasis?",
        answer: "Es la tendencia a la estabilidad de un sistema biológico mediante mecanismos de autorregulación."
    }
];

export default function AiSandbox({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    const [step, setStep] = useState<'input' | 'processing' | 'results'>('input');
    const [inputText] = useState("La síntesis de proteínas es el proceso por el cual se componen nuevas proteínas a partir de los veinte aminoácidos esenciales. En este proceso, se transcribe el ADN en ARN mensajero y luego se traduce en los ribosomas...");
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-slate-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">Demostración de generación automática</p>
                            </div>
                        </div>
                        <button 
                            onClick={onClose}
                            ...
                            >
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="px-2 py-1 rounded-md bg-amber-100 text-amber-700 text-[10px] font-bold uppercase tracking-wider">Modo Demo</span>
                                    </div>
                                    ...
                                    <p className="text-center text-xs text-muted-foreground italic">
                                        Subiendo tus propios documentos obtendrás resultados personalizados.
                                    </p>
                                </div>
                        ...
                        {step === 'processing' && (
                            <div className="py-12 flex flex-col items-center justify-center space-y-8">
                                ...
                                <div className="text-center space-y-2">
                                    <h4 className="text-xl font-bold">Procesando tus apuntes...</h4>
                                    <p className="text-sm text-muted-foreground">Nuestra IA está extrayendo los conceptos clave.</p>
                                </div>
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-green-500">
                                        ...
                                        <span className="text-sm font-bold uppercase tracking-wider">¡Éxito! 3 Flashcards generadas</span>
                                    </div>
                                    <button 
                                ...
                                <div className="space-y-3">
                                    {SAMPLE_FLASHCARDS.map((card, i) => (
                                        ...
                                        >
                                            <p className="text-xs font-bold text-primary mb-1">PREGUNTA {i + 1}</p>
                                            <p className="text-sm font-bold text-slate-900 mb-2">{card.question}</p>
                                ...
                                <div className="pt-4 border-t border-slate-100">
                                    <div className="bg-primary/5 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 border border-primary/10">
                                        <div className="text-center sm:text-left">
                                            <p className="text-sm font-bold text-slate-900">¿Quieres ver el resto?</p>
                                            <p className="text-[11px] text-muted-foreground">Regístrate para generar hasta 50 flashcards por documento.</p>
                                        </div>
