...
import { Sparkles, Brain, Shield, Zap, BookOpen, BarChart3 } from "lucide-react";
import { motion } from "motion/react";

const features = [
    {
        title: "Flashcards con IA",
        description: "Genera automáticamente tarjetas de memoria a partir de tus PDFs. El sistema extrae los conceptos clave y crea preguntas efectivas.",
        icon: Zap,
    ...
    },
    {
        ...
        description: "Crea guías paso a paso para dominar cualquier tema según el contenido de tus propios documentos.",
        icon: BarChart3,
        className: "col-span-1",
    ...
    },
    {
        ...
        description: "Ponte a prueba con exámenes generados dinámicamente que simulan evaluaciones reales de tu material.",
        icon: BookOpen,
        className: "col-span-1 md:col-span-2",
            ...
            <div className="memo-container relative z-10">
                <div className="flex flex-col items-center text-center mb-16">
                    ...
                    >
                        ...
                        <span className="text-[10px] font-bold text-primary uppercase tracking-widest">Poderes de estudio</span>
                    </motion.div>
                    
                    <h2 className="text-3xl md:text-4xl font-extrabold mb-4 tracking-tight max-w-2xl">
                        Todo lo que necesitas para <br />
                        <span className="memo-gradient-text text-4xl md:text-5xl">dominar tus materias</span>
                    </h2>
                    
                    <p className="text-lg text-muted-foreground max-w-xl font-light leading-relaxed">
                        Memo AI utiliza tecnología de punta para que tu estudio sea fluido, rápido y efectivo.
                    </p>
                </div>
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-4">
                                <div className={`w-12 h-12 rounded-xl ${feature.bgColor} flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300`}>
                                ...
                                {feature.className.includes('md:col-span-2') && (
                                    <div className="pt-2 flex gap-2">
                                        {[1,2,3].map(i => (
                                            <div key={i} className="h-1.5 flex-1 bg-muted rounded-full overflow-hidden">
                                                <motion.div 
                                                    initial={{ width: 0 }}
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center gap-5">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-2xl font-extrabold tracking-tight">Tu privacidad es sagrada</h3>
                                <p className="text-white/80 text-sm max-w-lg font-light">
                                    Documentos encriptados de extremo a extremo. Nunca entrenamos modelos públicos con tus datos.
                                </p>
                            </div>
                        </div>
