  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-primary/5 border border-primary/15 text-primary text-[11px] font-black uppercase tracking-[0.2em] mb-10 shadow-sm backdrop-blur-md"
      >
      ...
      >
        ...
        <span className="relative inline-block">
          ...
          >
            <motion.path
              d="M4 8C30 8 40 2 70 2C100 2 110 8 140 8C170 8 180 2 206 2"
              stroke="currentColor"
              strokeWidth="4"
              strokeLinecap="round"
      ...
      >
        {isAuthLoading ? (
          ...
          >
            <button className="group bg-foreground text-background px-10 py-5 rounded-[2rem] font-black text-lg shadow-2xl flex items-center gap-4 transition-all hover:scale-[1.02] active:scale-[0.98] hover:shadow-foreground/20">
              {user ? 'Mi Dashboard' : 'Empezar ahora'}
              <div className="w-8 h-8 rounded-full bg-background/10 dark:bg-black/10 flex items-center justify-center">
        ...
        >
          <div className="relative w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center shadow-lg group-hover:border-primary/50 group-hover:shadow-primary/10 transition-all">
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.2em]"
      >
