  ...
  return (
    <section className="relative pt-8 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
        <FloatingIcon
          Icon={Brain}
          className="top-[10%] left-[15%] text-primary/20"
          delay={0}
          duration={5}
        />
        <FloatingIcon
          Icon={FileText}
          className="top-[25%] right-[10%] text-blue-400/20"
          delay={1}
          duration={6}
        />
        <FloatingIcon
          Icon={Sparkles}
          className="bottom-[20%] left-[10%] text-amber-400/20"
          delay={2}
          duration={4}
        />
        <FloatingIcon
          Icon={CheckCircle2}
          className="bottom-[15%] right-[15%] text-green-400/20"
          delay={0.5}
          duration={7}
        />
      </div>
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="flex -space-x-3">
                      {[1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className="w-10 h-10 rounded-full border-2 border-[#0F1115] bg-white/10 shadow-xl"
                        />
                      ))}
                      <div className="w-10 h-10 rounded-full border-2 border-[#0F1115] bg-primary flex items-center justify-center text-[10px] font-bold text-white">
                        +12
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-white/5 to-white/2 border border-white/10 rounded-3xl p-6 relative overflow-hidden">
                    ...
                    <div className="space-y-6 max-w-xl">
                      ...
                      <h3 className="text-2xl font-bold text-white leading-tight">
                        ¿Cuáles son las fases principales de la mitosis celular?
                      </h3>
                      <p className="text-white/40 text-sm leading-relaxed">
                        Haz clic para ver la respuesta detallada y las
