  ...
  return (
    <Link href={`/dashboard/help/${slug}`}>
      <motion.div
        ...
        className="bg-card border border-border rounded-4xl p-8 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group cursor-pointer h-full"
      >
        <div
          className={`w-14 h-14 ${bg} ${color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
        >
