                    ...
                    <div className="relative z-10 space-y-6">
                        <div className="bg-white/50 backdrop-blur-sm p-4 rounded-2xl border border-white/20">
                            <div className="flex -space-x-2 justify-center mb-3">
                                ...
                                <div className="w-8 h-8 rounded-full border-2 border-white bg-primary flex items-center justify-center text-[10px] font-bold text-white">+5k</div>
                            </div>
                ...
                <div className="flex-1 p-8 md:p-16 flex flex-col bg-white font-sans">
                    ...
                    <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
                        ...
                        >
                            ...
                            <h1 className="text-3xl font-extrabold tracking-tight text-[#1A1C1E]">¡Crea tu cuenta!</h1>
                            <p className="text-muted-foreground mt-2 text-sm italic font-medium">Comienza hoy mismo tu transformación con IA.</p>
                        </motion.div>
