...
import ForgetPasswordForm from '@/components/auth/forms/forgetPassword-form';
          ...
          <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
            ...
            >
              ...
              <h1 className="text-3xl font-black tracking-tight text-foreground flex items-center justify-center gap-2">
                Recuperar acceso <Sparkles className="w-6 h-6 text-primary fill-primary" />
              </h1>
              <p className="text-muted-foreground mt-3 text-sm font-medium leading-relaxed">
                ¿Olvidaste tu contraseña? No te preocupes, <br />
                <span className="text-foreground italic">te ayudaremos a recuperarla.</span>
              </p>
            </motion.div>
