...
// Definimos un tipo estricto para los slugs de tus logros
...
export interface Achievement {
  ...
  title: string;
  description: string;
  icon: string; // Emoji, nombre de icono Lucide, o URL de badge visual
  category: AchievementCategory;
  target?: number; // Opcional: Meta numérica para la barra de progreso (ej. 7 para racha de 7)
}
